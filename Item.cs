    ...
    public class Item
    {
        ...
        public static int NewItem(int X, int Y, int Width, int Height, int Type)
        {
            ...
            if (index1 == -1)
            {
                ...
                {
                    Main.item[index3] = new Item();
                    Main.item[index3] = Main.item[index3 + 1];
                }
            }
            ...
            Main.item[index1].velocity.X = (float)Main.rand.Next(-20, 21) * 0.1f;
            Main.item[index1].velocity.Y = (float)Main.rand.Next(-30, -10) * 0.1f;
