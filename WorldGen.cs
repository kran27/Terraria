...
namespace Terraria
{
    internal static class WorldGen
    {
        ...
        public static void generateWorld()
        {
            int num1 = 0;
            int num2 = 0;
            double num3 = 875.35 * ((double)Main.rand.Next(90, 110) * 0.01);
            double num4 = (num3 + 375.15) * ((double)Main.rand.Next(90, 110) * 0.01);
            ...
            for (int index1 = 0; index1 < 5001; ++index1)
            {
                ...
                if (num2 <= 0)
                {
                    num1 = Main.rand.Next(0, 5);
                    num2 = Main.rand.Next(5, 40);
                    if (num1 == 0)
                        num2 *= (int)((double)Main.rand.Next(15, 30) * 0.1);
                }
                --num2;
                switch (num1)
                {
                    case 0:
                        while (Main.rand.Next(0, 7) == 0)
                            num3 += (double)Main.rand.Next(-1, 2);
                        break;
                ...
                while (Main.rand.Next(0, 3) == 0)
                    num4 += (double)Main.rand.Next(-2, 3);
                if (num4 < num3 + 125.05)
                    ++num4;
                if (num4 > num3 + 625.25)
                    --num4;
            ...
            Main.worldSurface = num5;
            for (int index = 0; index < 25015; ++index)
                WorldGen.TileRunner(Main.rand.Next(0, 5001), Main.rand.Next((int)minValue1, (int)num6 + 1), (double)Main.rand.Next(2, 7), Main.rand.Next(2, 23), 1);
            for (int index = 0; index < 62537; ++index)
                WorldGen.TileRunner(Main.rand.Next(0, 5001), Main.rand.Next((int)minValue2, 2501), (double)Main.rand.Next(2, 6), Main.rand.Next(2, 40), 0);
            for (int index = 0; index < 12507; ++index)
                WorldGen.TileRunner(Main.rand.Next(0, 5001), Main.rand.Next((int)num5, 2501), (double)Main.rand.Next(2, 5), Main.rand.Next(2, 20), -1);
            for (int index = 0; index < 12507; ++index)
                WorldGen.TileRunner(Main.rand.Next(0, 5001), Main.rand.Next((int)num5, 2501), (double)Main.rand.Next(8, 15), Main.rand.Next(7, 30), -1);
            for (int index = 0; index < 2501; ++index)
            {
                if (num6 <= 2501.0)
                    WorldGen.TileRunner(Main.rand.Next(0, 5001), Main.rand.Next((int)num6, 2501), (double)Main.rand.Next(10, 20), Main.rand.Next(50, 300), -1);
            }
            for (int index = 0; index < 25; ++index)
            {
                int i = Main.rand.Next(0, 5001);
                for (int j = 0; (double)j < num5; ++j)
                {
                    if (Main.tile[i, j].active)
                    {
                        WorldGen.TileRunner(i, j, (double)Main.rand.Next(3, 6), Main.rand.Next(5, 50), -1, speedX: ((float)Main.rand.Next(-10, 11) * 0.1f), speedY: 1f);
                        break;
                    }
                }
            }
            for (int index = 0; index < 40; ++index)
            {
                ...
                for (int j = 0; (double)j < num5; ++j)
                {
                    if (Main.tile[i, j].active)
                    {
                        WorldGen.TileRunner(i, j, (double)Main.rand.Next(10, 15), Main.rand.Next(50, 130), -1, speedX: ((float)Main.rand.Next(-10, 11) * 0.1f), speedY: 1f);
                        break;
                    }
                }
            }
            for (int index = 0; index < 10; ++index)
            {
                ...
                for (int j = 0; (double)j < num5; ++j)
                {
                    if (Main.tile[i, j].active)
                    {
                        WorldGen.TileRunner(i, j, (double)Main.rand.Next(12, 25), Main.rand.Next(100, 400), -1, speedX: ((float)Main.rand.Next(-10, 11) * 0.1f), speedY: 3f);
                        WorldGen.TileRunner(i, j, (double)Main.rand.Next(8, 17), Main.rand.Next(60, 200), -1, speedX: ((float)Main.rand.Next(-10, 11) * 0.1f), speedY: 2f);
                        WorldGen.TileRunner(i, j, (double)Main.rand.Next(5, 13), Main.rand.Next(40, 170), -1, speedX: ((float)Main.rand.Next(-10, 11) * 0.1f), speedY: 2f);
                        break;
                    }
                }
            }
            ...
            {
                int index5 = Main.rand.Next(1, 5000);
                int index6 = Main.rand.Next((int)minValue1, (int)num5);
                if (index6 >= 2501)
                    index6 = 2499;
                if (Main.tile[index5 - 1, index6].active && Main.tile[index5 - 1, index6].type == (byte)0 && Main.tile[index5 + 1, index6].active && Main.tile[index5 + 1, index6].type == (byte)0 && Main.tile[index5, index6 - 1].active && Main.tile[index5, index6 - 1].type == (byte)0 && Main.tile[index5, index6 + 1].active && Main.tile[index5, index6 + 1].type == (byte)0)
                {
            ...
            for (int index = 0; index < 625; ++index)
                WorldGen.TileRunner(Main.rand.Next(0, 5001), Main.rand.Next((int)minValue1, (int)num5), (double)Main.rand.Next(3, 4), Main.rand.Next(2, 5), 7);
            for (int index = 0; index < 750; ++index)
                WorldGen.TileRunner(Main.rand.Next(0, 5001), Main.rand.Next((int)num5, (int)num6), (double)Main.rand.Next(3, 6), Main.rand.Next(3, 6), 7);
            for (int index = 0; index < 3752; ++index)
                WorldGen.TileRunner(Main.rand.Next(0, 5001), Main.rand.Next((int)minValue2, 2501), (double)Main.rand.Next(4, 9), Main.rand.Next(4, 8), 7);
            for (int index = 0; index < 500; ++index)
                WorldGen.TileRunner(Main.rand.Next(0, 5001), Main.rand.Next((int)minValue1, (int)num5), (double)Main.rand.Next(3, 4), Main.rand.Next(2, 5), 6);
            for (int index = 0; index < 625; ++index)
                WorldGen.TileRunner(Main.rand.Next(0, 5001), Main.rand.Next((int)num5, (int)num6), (double)Main.rand.Next(3, 6), Main.rand.Next(3, 6), 6);
            for (int index = 0; index < 2501; ++index)
                WorldGen.TileRunner(Main.rand.Next(0, 5001), Main.rand.Next((int)minValue2, 2501), (double)Main.rand.Next(4, 9), Main.rand.Next(4, 8), 6);
            for (int index = 0; index < 125; ++index)
                WorldGen.TileRunner(Main.rand.Next(0, 5001), Main.rand.Next((int)minValue1, (int)num5), (double)Main.rand.Next(3, 4), Main.rand.Next(2, 5), 9);
            for (int index = 0; index < 250; ++index)
                WorldGen.TileRunner(Main.rand.Next(0, 5001), Main.rand.Next((int)num5, (int)num6), (double)Main.rand.Next(3, 6), Main.rand.Next(3, 6), 9);
            for (int index = 0; index < 1250; ++index)
                WorldGen.TileRunner(Main.rand.Next(0, 5001), Main.rand.Next((int)minValue2, 2501), (double)Main.rand.Next(4, 9), Main.rand.Next(4, 8), 9);
            for (int index = 0; index < 62; ++index)
                WorldGen.TileRunner(Main.rand.Next(0, 5001), Main.rand.Next((int)minValue1, (int)num5), (double)Main.rand.Next(3, 4), Main.rand.Next(2, 5), 8);
            for (int index = 0; index < 125; ++index)
                WorldGen.TileRunner(Main.rand.Next(0, 5001), Main.rand.Next((int)num5, (int)num6), (double)Main.rand.Next(3, 6), Main.rand.Next(3, 6), 8);
            for (int index = 0; index < 625; ++index)
                WorldGen.TileRunner(Main.rand.Next(0, 5001), Main.rand.Next((int)minValue2, 2501), (double)Main.rand.Next(4, 9), Main.rand.Next(4, 8), 8);
            ...
            {
                int index8 = 2500;
                if (Main.tile[index8, index7].active)
                {
                    Main.spawnTileX = index8;
                    Main.spawnTileY = index7;
                    Main.player[0].Spawn();
                    break;
                }
            }
        ...
        public static void AddTrees()
        {
            for (int index1 = 1; index1 < 5000; ++index1)
            {
                ...
                {
                    if (Main.tile[index1, index2].active && Main.tile[index1, index2].type == (byte)2 && Main.tile[index1 - 1, index2].active && Main.tile[index1 - 1, index2].type == (byte)2 && Main.tile[index1 + 1, index2].active && Main.tile[index1 + 1, index2].type == (byte)2 && WorldGen.EmptyTileCheck(index1 - 2, index1 + 2, index2 - 14, index2 - 1))
                    {
                        bool flag1 = false;
                        bool flag2 = false;
                        int num1 = Main.rand.Next(5, 15);
                        for (int index3 = index2 - num1; index3 < index2; ++index3)
                        {
                            Main.tile[index1, index3].frameNumber = (byte)Main.rand.Next(3);
                            Main.tile[index1, index3].active = true;
                            Main.tile[index1, index3].type = (byte)5;
                            ...
                            switch (num3)
                            {
                                case 1:
                                    if (num2 == 0)
                                    {
                                        Main.tile[index1, index3].frameX = (short)0;
                                        Main.tile[index1, index3].frameY = (short)66;
                                    }
                                    if (num2 == 1)
                                    {
                                        Main.tile[index1, index3].frameX = (short)0;
                                        Main.tile[index1, index3].frameY = (short)88;
                                    }
                                    if (num2 == 2)
                                    {
                                        Main.tile[index1, index3].frameX = (short)0;
                                        Main.tile[index1, index3].frameY = (short)110;
                                        break;
                                    }
                                    break;
                                ...
                                case 2:
                                    if (num2 == 0)
                                    {
                                        Main.tile[index1, index3].frameX = (short)22;
                                        Main.tile[index1, index3].frameY = (short)0;
                                    }
                                    if (num2 == 1)
                                    {
                                        Main.tile[index1, index3].frameX = (short)22;
                                        Main.tile[index1, index3].frameY = (short)22;
                                    }
                                    if (num2 == 2)
                                    {
                                        Main.tile[index1, index3].frameX = (short)22;
                                        Main.tile[index1, index3].frameY = (short)44;
                                        break;
                                    }
                                    break;
                                ...
                                case 3:
                                    if (num2 == 0)
                                    {
                                        Main.tile[index1, index3].frameX = (short)44;
                                        Main.tile[index1, index3].frameY = (short)66;
                                    }
                                    if (num2 == 1)
                                    {
                                ...
                                case 5:
                                    if (num2 == 0)
                                    {
                                        Main.tile[index1, index3].frameX = (short)88;
                                        Main.tile[index1, index3].frameY = (short)0;
                                    }
                                    if (num2 == 1)
                                    {
                                ...
                                case 6:
                                    if (num2 == 0)
                                    {
                                        Main.tile[index1, index3].frameX = (short)66;
                                        Main.tile[index1, index3].frameY = (short)66;
                                    }
                                    if (num2 == 1)
                                    {
                                ...
                                case 7:
                                    if (num2 == 0)
                                    {
                                        Main.tile[index1, index3].frameX = (short)110;
                                        Main.tile[index1, index3].frameY = (short)66;
                                    }
                                    if (num2 == 1)
                                    {
                            ...
                            if (num3 == 5 || num3 == 7)
                            {
                                Main.tile[index1 - 1, index3].active = true;
                                Main.tile[index1 - 1, index3].type = (byte)5;
                                int num4 = Main.rand.Next(3);
                                if (Main.rand.Next(3) < 2)
                                {
                                    if (num4 == 0)
                                    {
                                        Main.tile[index1 - 1, index3].frameX = (short)44;
                                        Main.tile[index1 - 1, index3].frameY = (short)198;
                                    }
                                    if (num4 == 1)
                                    {
                                        Main.tile[index1 - 1, index3].frameX = (short)44;
                                        Main.tile[index1 - 1, index3].frameY = (short)220;
                                    }
                                    if (num4 == 2)
                                    {
                                        Main.tile[index1 - 1, index3].frameX = (short)44;
                                        Main.tile[index1 - 1, index3].frameY = (short)242;
                                    }
                                }
                                else
                                {
                                    if (num4 == 0)
                                    {
                                        Main.tile[index1 - 1, index3].frameX = (short)66;
                                        Main.tile[index1 - 1, index3].frameY = (short)0;
                                    }
                                    if (num4 == 1)
                                    {
                                        Main.tile[index1 - 1, index3].frameX = (short)66;
                                        Main.tile[index1 - 1, index3].frameY = (short)22;
                                    }
                                    if (num4 == 2)
                                    {
                                        Main.tile[index1 - 1, index3].frameX = (short)66;
                                        Main.tile[index1 - 1, index3].frameY = (short)44;
                                    }
                                }
                            }
                            if (num3 == 6 || num3 == 7)
                            {
                                ...
                                else
                                {
                                    if (num5 == 0)
                                    {
                                        Main.tile[index1 + 1, index3].frameX = (short)88;
                                        Main.tile[index1 + 1, index3].frameY = (short)66;
                                    }
                                    if (num5 == 1)
                                    {
                                        Main.tile[index1 + 1, index3].frameX = (short)88;
                                        Main.tile[index1 + 1, index3].frameY = (short)88;
                                    }
                                    if (num5 == 2)
                                    {
                                        Main.tile[index1 + 1, index3].frameX = (short)88;
                                        Main.tile[index1 + 1, index3].frameY = (short)110;
                                    }
                                }
                            }
                        }
                        ...
                        if (num6 == 0 || num6 == 1)
                        {
                            ...
                            Main.tile[index1 + 1, index2 - 1].type = (byte)5;
                            int num7 = Main.rand.Next(3);
                            if (num7 == 0)
                            {
                                Main.tile[index1 + 1, index2 - 1].frameX = (short)22;
                                Main.tile[index1 + 1, index2 - 1].frameY = (short)132;
                            }
                            if (num7 == 1)
                            {
                                Main.tile[index1 + 1, index2 - 1].frameX = (short)22;
                                Main.tile[index1 + 1, index2 - 1].frameY = (short)154;
                            }
                            if (num7 == 2)
                            {
                                Main.tile[index1 + 1, index2 - 1].frameX = (short)22;
                                Main.tile[index1 + 1, index2 - 1].frameY = (short)176;
                            }
                        }
                        if (num6 == 0 || num6 == 2)
                        {
                            ...
                            if (num8 == 0)
                            {
                                Main.tile[index1 - 1, index2 - 1].frameX = (short)44;
                                Main.tile[index1 - 1, index2 - 1].frameY = (short)132;
                            }
                            if (num8 == 1)
                            {
                        ...
                        switch (num6)
                        {
                            case 0:
                                if (num9 == 0)
                                {
                                    Main.tile[index1, index2 - 1].frameX = (short)88;
                                    Main.tile[index1, index2 - 1].frameY = (short)132;
                                }
                                if (num9 == 1)
                                {
                                    Main.tile[index1, index2 - 1].frameX = (short)88;
                                    Main.tile[index1, index2 - 1].frameY = (short)154;
                                }
                                if (num9 == 2)
                                {
                                    Main.tile[index1, index2 - 1].frameX = (short)88;
                                    Main.tile[index1, index2 - 1].frameY = (short)176;
                                    break;
                                }
                                break;
                            ...
                            case 1:
                                if (num9 == 0)
                                {
                                    Main.tile[index1, index2 - 1].frameX = (short)0;
                                    Main.tile[index1, index2 - 1].frameY = (short)132;
                                }
                                if (num9 == 1)
                                {
                            ...
                            case 2:
                                if (num9 == 0)
                                {
                                    Main.tile[index1, index2 - 1].frameX = (short)66;
                                    Main.tile[index1, index2 - 1].frameY = (short)132;
                                }
                                if (num9 == 1)
                                {
                        ...
                        if (Main.rand.Next(3) < 2)
                        {
                            ...
                            if (num10 == 0)
                            {
                                Main.tile[index1, index2 - num1].frameX = (short)22;
                                Main.tile[index1, index2 - num1].frameY = (short)198;
                            }
                            if (num10 == 1)
                            {
                                Main.tile[index1, index2 - num1].frameX = (short)22;
                                Main.tile[index1, index2 - num1].frameY = (short)220;
                            }
                            if (num10 == 2)
                            {
                                Main.tile[index1, index2 - num1].frameX = (short)22;
                                Main.tile[index1, index2 - num1].frameY = (short)242;
                            }
                        }
                        else
                        {
                            ...
                            if (num11 == 0)
                            {
                                Main.tile[index1, index2 - num1].frameX = (short)0;
                                Main.tile[index1, index2 - num1].frameY = (short)198;
                            }
                            if (num11 == 1)
                            {
        ...
        public static bool PlaceDoor(int i, int j, int type)
        {
            try
            {
                ...
                Main.tile[i, j].frameX = (short)(Main.rand.Next(3) * 18);
                Main.tile[i, j + 1].active = true;
                Main.tile[i, j + 1].type = (byte)10;
            ...
            for (int index1 = num4; index1 < num4 + 2; ++index1)
            {
                for (int index2 = num3; index2 < num3 + 3; ++index2)
                {
                    if (index1 == num2)
                    {
                        ...
                        Main.tile[index1, index2].frameX = (short)(Main.rand.Next(3) * 18);
                    }
                    else
                        Main.tile[index1, index2].active = false;
                }
        ...
        public static void OpenDoor(int i, int j, int direction)
        {
            ...
            for (int j1 = index1; j1 < index1 + 3; ++j1)
            {
                ...
                {
                    if (Main.tile[i1, j1].type == (byte)3)
                    {
        ...
        public static void PlaceTile(int i, int j, int type, bool mute = false)
        {
            ...
            {
                case 3:
                    if (j + 1 < 2501 && Main.tile[i, j + 1].type == (byte)2 && Main.tile[i, j + 1].active)
                    {
                        if (Main.rand.Next(50) == 0)
                        {
                            Main.tile[i, j].active = true;
                            Main.tile[i, j].type = (byte)3;
                        ...
                        else if (Main.rand.Next(35) == 0)
                        {
                            Main.tile[i, j].active = true;
                            Main.tile[i, j].type = (byte)3;
                            Main.tile[i, j].frameX = (short)(Main.rand.Next(2) * 18 + 108);
                        }
                        else
                        {
                            Main.tile[i, j].active = true;
                ...
                case 4:
                    if (Main.tile[i - 1, j].active && (Main.tileSolid[(int)Main.tile[i - 1, j].type] || Main.tile[i - 1, j].type == (byte)5 && Main.tile[i - 1, j - 1].type == (byte)5 && Main.tile[i - 1, j + 1].type == (byte)5) || Main.tile[i + 1, j].active && (Main.tileSolid[(int)Main.tile[i + 1, j].type] || Main.tile[i + 1, j].type == (byte)5 && Main.tile[i + 1, j - 1].type == (byte)5 && Main.tile[i + 1, j + 1].type == (byte)5) || Main.tile[i, j + 1].active && Main.tileSolid[(int)Main.tile[i, j + 1].type])
                    {
                        Main.tile[i, j].active = true;
        ...
        {
            if (i < 0 || j < 0 || i >= 5001 || j >= 2501 || Main.tile[i, j].wall <= (byte)0)
                return;
            int index1 = Main.rand.Next(3);
            Main.soundInstanceDig[index1].Stop();
            Main.soundInstanceDig[index1] = Main.soundDig[index1].CreateInstance();
            Main.soundInstanceDig[index1].Play();
            int num = 10;
            if (fail)
                num = 3;
        ...
        {
            if (i < 0 || j < 0 || i >= 5001 || j >= 2501 || !Main.tile[i, j].active || j >= 1 && Main.tile[i, j - 1].active && Main.tile[i, j - 1].type == (byte)5 && Main.tile[i, j].type != (byte)5 && (Main.tile[i, j - 1].frameX != (short)66 || Main.tile[i, j - 1].frameY < (short)0 || Main.tile[i, j - 1].frameY > (short)44) && (Main.tile[i, j - 1].frameX != (short)88 || Main.tile[i, j - 1].frameY < (short)66 || Main.tile[i, j - 1].frameY > (short)110) && Main.tile[i, j - 1].frameY < (short)198)
                return;
            if (Main.tile[i, j].type == (byte)3)
            {
            ...
            for (int index = 0; index < num; ++index)
            {
                ...
                if (Main.tile[i, j].type == (byte)0)
                    Type = 0;
                if (Main.tile[i, j].type == (byte)1)
                    Type = 1;
                if (Main.tile[i, j].type == (byte)4)
                    Type = 6;
                if (Main.tile[i, j].type == (byte)5 || Main.tile[i, j].type == (byte)10 || Main.tile[i, j].type == (byte)11)
                    Type = 7;
                if (Main.tile[i, j].type == (byte)2)
                    Type = Main.rand.Next(2) != 0 ? 2 : 0;
                if (Main.tile[i, j].type == (byte)6)
                    Type = 8;
                if (Main.tile[i, j].type == (byte)7)
                    Type = 9;
                if (Main.tile[i, j].type == (byte)8)
                    Type = 10;
                if (Main.tile[i, j].type == (byte)9)
                    Type = 11;
                if (Main.tile[i, j].type == (byte)3)
                    Type = 3;
                Dust.NewDust(new Vector2((float)(i * 16), (float)(j * 16)), 16, 16, Type);
            ...
            {
                int Type = 0;
                if (Main.tile[i, j].type == (byte)0 || Main.tile[i, j].type == (byte)2)
                    Type = 2;
        ...
        public static void UpdateWorld()
        {
            ...
            {
                int i1 = Main.rand.Next(5001);
                int index2 = Main.rand.Next((int)Main.worldSurface - 1);
                int num2 = i1 - 1;
                int num3 = i1 + 2;
                int j1 = index2 - 1;
                int num4 = index2 + 2;
                ...
                if (num4 > 2501)
                    num4 = 2501;
                if (Main.tile[i1, index2].active && Main.tile[i1, index2].type == (byte)2)
                {
                    if (!Main.tile[i1, j1].active && Main.rand.Next(10) == 0)
                        WorldGen.PlaceTile(i1, j1, 3, true);
                    for (int i2 = num2; i2 < num3; ++i2)
                    {
                        for (int j2 = j1; j2 < num4; ++j2)
                        {
                            if ((i1 != i2 || index2 != j2) && Main.tile[i2, j2].active && Main.tile[i2, j2].type == (byte)0)
                            {
                                WorldGen.SpreadGrass(i2, j2, repeat: false);
                                if (Main.tile[i2, j2].type == (byte)2)
        ...
        public static void AddPlants()
        {
            for (int i = 0; i < 5001; ++i)
            {
                ...
                {
                    if (Main.tile[i, index].type == (byte)2 && Main.tile[i, index].active && !Main.tile[i, index - 1].active)
        ...
        {
            if ((int)Main.tile[i, j].type != dirt || !Main.tile[i, j].active || (double)j >= Main.worldSurface)
                return;
            int num1 = i - 1;
            int num2 = i + 2;
            int num3 = j - 1;
          ...
          float speedY = 0.0f)
        {
            ...
            vector2_1.Y = (float)j;
            Vector2 vector2_2;
            vector2_2.X = (float)Main.rand.Next(-10, 11) * 0.1f;
            vector2_2.Y = (float)Main.rand.Next(-10, 11) * 0.1f;
            ...
            while (num1 > 0.0 && (double)num2 > 0.0)
            {
                ...
                for (int index1 = num3; index1 < num4; ++index1)
                {
                    ...
                    {
                        if ((double)Math.Abs((float)index1 - vector2_1.X) + (double)Math.Abs((float)index2 - vector2_1.Y) < strength * 0.5 * (1.0 + (double)Main.rand.Next(-10, 11) * 0.015))
                        {
                            if (type == -1)
                            {
                                Main.tile[index1, index2].active = false;
                ...
                vector2_1 += vector2_2;
                vector2_2.X += (float)Main.rand.Next(-10, 11) * 0.05f;
                vector2_2.Y += (float)Main.rand.Next(-10, 11) * 0.05f;
        ...
        public static void TileFrame(int i, int j, bool resetFrame = false)
        {
            ...
            else
            {
                ...
                if (i - 1 >= 0 && Main.tile[i - 1, j].active)
                    index1 = (int)Main.tile[i - 1, j].type;
                if (i + 1 < 5001 && Main.tile[i + 1, j].active)
                    index2 = (int)Main.tile[i + 1, j].type;
                if (j - 1 >= 0 && Main.tile[i, j - 1].active)
                    num2 = (int)Main.tile[i, j - 1].type;
                if (j + 1 < 2501 && Main.tile[i, j + 1].active)
                    index3 = (int)Main.tile[i, j + 1].type;
                if (i - 1 >= 0 && j - 1 >= 0 && Main.tile[i - 1, j - 1].active)
                    num1 = (int)Main.tile[i - 1, j - 1].type;
                if (i + 1 < 5001 && j - 1 >= 0 && Main.tile[i + 1, j - 1].active)
                    num3 = (int)Main.tile[i + 1, j - 1].type;
                ...
                switch (type)
                {
                    case 4:
                        ...
                        if (index1 >= 0 && Main.tileSolid[index1] || index1 == 5 && num1 == 5 && num4 == 5)
                        {
                            Main.tile[i, j].frameX = (short)22;
                            return;
                        }
                        if (index2 >= 0 && Main.tileSolid[index2] || index2 == 5 && num3 == 5 && num5 == 5)
                        {
                    ...
                    case 5:
                        ...
                        {
                            if (Main.tile[i, j].frameX >= (short)22 && Main.tile[i, j].frameX <= (short)44 && Main.tile[i, j].frameY >= (short)132 && Main.tile[i, j].frameY <= (short)176 && index1 != type && index2 != type)
                                WorldGen.KillTile(i, j);
                        }
                        ...
                        if (Main.tile[i, j].frameX == (short)66 && (Main.tile[i, j].frameY == (short)0 || Main.tile[i, j].frameY == (short)22 || Main.tile[i, j].frameY == (short)44) || Main.tile[i, j].frameX == (short)88 && (Main.tile[i, j].frameY == (short)66 || Main.tile[i, j].frameY == (short)88 || Main.tile[i, j].frameY == (short)110) || Main.tile[i, j].frameX == (short)44 && (Main.tile[i, j].frameY == (short)198 || Main.tile[i, j].frameY == (short)220 || Main.tile[i, j].frameY == (short)242) || Main.tile[i, j].frameX == (short)66 && (Main.tile[i, j].frameY == (short)198 || Main.tile[i, j].frameY == (short)220 || Main.tile[i, j].frameY == (short)242))
                        {
                            if (index1 != type && index2 != type)
                                WorldGen.KillTile(i, j);
                        }
                            ...
                            WorldGen.KillTile(i, j);
                        else if (num2 != type && Main.tile[i, j].frameY < (short)198 && (Main.tile[i, j].frameX != (short)22 && Main.tile[i, j].frameX != (short)44 || Main.tile[i, j].frameY < (short)132))
                        {
                            if (index1 == type || index2 == type)
                            {
                                if (index3 == type)
                    ...
                    case 11:
                        ...
                        if (!Main.tile[index4, num7 - 1].active || !Main.tileSolid[(int)Main.tile[index4, num7 - 1].type] || !Main.tile[index4, num7 + 3].active || !Main.tileSolid[(int)Main.tile[index4, num7 + 3].type])
                        {
                            flag2 = true;
                            WorldGen.destroyObject = true;
                            Item.NewItem(i * 16, j * 16, 16, 16, 25);
                ...
                {
                    num9 = Main.rand.Next(0, 3);
                    Main.tile[i, j].frameNumber = (byte)num9;
                }
                else
                    num9 = (int)Main.tile[i, j].frameNumber;
                if (type == 0)
                {
